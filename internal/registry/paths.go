// Package registry is the single source of truth for the memcli project
// registry. It handles reading and writing the registry file, transparent
// v1->v2 migration, and mutating operations (Touch, Prune).
package registry
...
//  2. $HOME/.claude/memcli/projects.json (canonical location, same as the
//     pre-rename mem-cli v0.1.0 binary so existing users keep their list)
//
